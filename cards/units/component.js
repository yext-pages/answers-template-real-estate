{{> cards/card_component componentName='units' }}

class unitsCardComponent extends BaseCard['units'] {
...
ANSWERS.registerTemplate(
  'cards/units',
  `{{{read 'cards/units/template' }}}`
);
ANSWERS.registerComponentType(unitsCardComponent);
