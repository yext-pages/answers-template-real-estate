{{> cards/card_component componentName='blog' }}

class blogCardComponent extends BaseCard['blog'] {
...
ANSWERS.registerTemplate(
  'cards/blog',
  `{{{read 'cards/blog/template' }}}`
);
ANSWERS.registerComponentType(blogCardComponent);
